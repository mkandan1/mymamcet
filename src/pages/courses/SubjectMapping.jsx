...
//     const batchId = allBatches.find(b => b.batchName.includes(batch.batchName))._id;
//     console.log(batchId);
//     const data = {program: batch.program, department: batch.department, batchName: batch.batchName, academicYear: batch.academicYear, semester: batch.semester, regulation: batch.regulation.value, subjects: arrayOfSubjectIds, batchId }
...
//           const batchNames = allBatches.map((batch) => (batch.batchName));
//           setBatchNames(batchNames.length > 0 ? batchNames : ['No batches found']);
//         }
//       }
//       fetch()
//     }
//   }, [batch.department, allBatches]);
...
//       // const fetchedSemester = semesterService.getSemester(batch.program, batch.department, batch.batchName)
