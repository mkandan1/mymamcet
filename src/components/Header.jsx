...
export const Header = () => {
    ...
    return (
        <div className='w-screen h-16 bg-blue-500 md:bg-white absolute md:relative top-0'>
                ...
                <div className='flex w-full h-full justify-end'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='ml-2'>
                            ...
                            <p className='text-xs font-inter text-blue-300 md:text-slate-400'>Last login: 10, Apr, 2023 10:23 AM</p>
                        </div>
                    </div>
                </div>
            </header>
